...
public final class CsvUtils {
    ...
    public static <T> List<T> getCsvBeans(String resourcePath, Class<? extends T> beanClass) {
        Reader reader = new BufferedReader(new InputStreamReader(Objects.requireNonNull(CsvUtils.class.getClassLoader().getResourceAsStream(resourcePath)), StandardCharsets.UTF_8));
